<template>
  ...
  <b-row v-else>
    <b-col v-if="content.translations[selectedLanguage]">
      <b-card no-body class="mb-2 whatnow-collapse-card">
        <b-card-header header-tag="header" class="pl-2 pt-3 pb-3 pr-2 rounded-bottom" role="tab">
          <div class="d-flex align-items-center">
            ...
            <div class="ml-2 rtl-mr-2">
              <h4>{{ content.currentTranslation.title }}</h4>
        ...
        <b-collapse :id="`accordion-${content.id}`" accordion="content-accordion" role="tabpanel" v-model="showCollapse">
